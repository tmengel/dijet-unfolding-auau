...
root -l -q -b "createResponse_exclusive_v2_AA.cxx(\"${sysconfig}\", 0, 10, ${conesize}, ${cent}, 1, \"${exclusive_dir}\")"
...
root -l -q -b "createResponse_exclusive_v2_AA.cxx(\"${sysconfig}\", 0, 10, ${conesize}, ${cent}, 2, \"${exclusive_dir}\")"
root -l -q -b "unfoldData_noempty_AA.cxx(\"${sysconfig}\", 10, ${conesize}, ${cent}, 2)"

root -l -q -b "createResponse_exclusive_v2_AA.cxx(\"${sysconfig}\", 0, 10, ${conesize}, ${cent}, 0, \"${exclusive_dir}\")"
