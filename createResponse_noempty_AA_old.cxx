...
int createResponse_noempty_AA_old(const std::string configfile = "binning.config", const int full_or_half = 0, const int niterations = 10, const int cone_size = 4, const int centrality_bin = 0, const int primer = 0)
{
  gStyle->SetOptStat(0);
