...
void compare_jet_kinematics(const char *fileA = "/sphenix/user/tmengel/JetUESub-JSTG-TF03/macros/data/rootfiles/run2auau_rho_jet.root",
                             const char *fileB = "/sphenix/tg/tg01/jets/tmengel/ppg14/data/v004_20260821/data_v004_20260821_calibrated_merged.root",
                             const char *nameA = "v001",
                             const char *nameB = "v004",
                             Long64_t nentries = 5000000,
                             const char *outbase = "jet_kinematics_compare")
{
  const char *sel = "jet_pT>8 && fabs(zvrtx)<60";
