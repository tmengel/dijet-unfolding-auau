...
export AUAU_DATA_PATH="${PPG14_PATH}/rootfiles/v001_20260720"
export AUAU_SIM_PATH="${PPG14_PATH}/rootfiles/v001_20260720"
export JESR_PATH="${DIJET_UNFOLDING_PATH}/jer"
