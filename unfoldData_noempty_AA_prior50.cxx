...
// Counterpart to createResponse_noempty_AA_prior50.cxx: identical to
// unfoldData_noempty_AA.cxx except it looks up/writes files tagged
// "PRIOR50" instead of "PRIOR", matching the response-matrix side.
int unfoldData_noempty_AA_prior50(const std::string configfile = "binning_AA.config", const int niterations = 10, const int cone_size = 3, const int centrality_bin = 0, const int primer = 0)
{
  gStyle->SetOptStat(0);
